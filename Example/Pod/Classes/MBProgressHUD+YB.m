...
@implementation MBProgressHUD (YB)
...
{
    if (view == nil) view = [MBProgressHUD lastWindow];
    // 快速显示一个提示信息
...
+ (void)toast:(NSString *)message ToView:(UIView *)view{
    ...
    toastHUD.bezelView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.9];
    // 隐藏时候从父控件中移除
